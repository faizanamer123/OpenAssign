...
export default function ActivityPage() {
  ...
  const loadUserActivity = async () => {
    ...
    try {
      ...
      setMyAssignments(allAssignments.filter((a: any) => a.createdBy === user?.id))
    ...
    <div className="min-h-screen bg-[#fcfbf8]">
      ...
      <div className="px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-[#1c180d] mb-2">My Activity</h1>
            <p className="text-[#9e8747]">Track your uploaded assignments and submitted solutions.</p>
          </div>
          ...
          <Tabs defaultValue="uploaded" className="space-y-6">
            ...
            <TabsContent value="uploaded" className="space-y-6">
              <Card className="border-[#e9e2ce] bg-[#fcfbf8]">
                <CardHeader>
                  <CardTitle className="text-[#1c180d]">Assignments You've Uploaded</CardTitle>
                ...
                <CardContent>
                  {loading ? (
                    <p className="text-[#9e8747] text-center py-8">Loading your assignments...</p>
                  ) : myAssignments.length === 0 ? (
                    <div className="text-center py-8">
                      <p className="text-[#9e8747] mb-4">You haven't uploaded any assignments yet.</p>
                      <Link href="/upload">
                    ...
                    <div className="space-y-4">
                      {myAssignments.map((assignment) => (
                        <Card key={assignment.id} className="border-[#e9e2ce] bg-[#fcfbf8]">
                            ...
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-2">
                                  ...
                                  <Badge className="bg-blue-100 text-blue-800">{assignment.difficulty}</Badge>
                                </div>
                                <h3 className="font-semibold text-[#1c180d] mb-2">{assignment.title}</h3>
                                <p className="text-[#9e8747] text-sm mb-3 line-clamp-2">{assignment.description}</p>
            ...
            <TabsContent value="submitted" className="space-y-6">
              <Card className="border-[#e9e2ce] bg-[#fcfbf8]">
                <CardHeader>
                  <CardTitle className="text-[#1c180d]">Solutions You've Submitted</CardTitle>
                  <CardDescription className="text-[#9e8747]">
                ...
                <CardContent>
                  {loading ? (
                    <p className="text-[#9e8747] text-center py-8">Loading your submissions...</p>
                  ) : mySubmissions.length === 0 ? (
                    <div className="text-center py-8">
                      <p className="text-[#9e8747] mb-4">You haven't submitted any solutions yet.</p>
                      <Link href="/browse">
                        <Button className="bg-[#fac638] text-[#1c180d] hover:bg-[#fac638]/90">
                          ...
                          <CardContent className="p-6">
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                ...
                                <h3 className="font-semibold text-[#1c180d] mb-2">Assignment Solution</h3>
