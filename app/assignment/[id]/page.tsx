    ...
    return (
      <div className="min-h-screen bg-[#fcfbf8]">
        ...
        <div className="text-center py-20">
          ...
          <Button
            onClick={() => router.back()}
            className="mt-4 bg-[#fac638] text-[#1c180d]"
          >
            Go Back
          </Button>
        </div>
            ...
            <CardHeader>
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <CardTitle className="text-2xl text-[#1c180d] mb-2">
                    {assignment.title}
                  </CardTitle>
                  <CardDescription className="text-[#9e8747] text-base">
            ...
            <CardContent>
              {canSubmit ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-[#1c180d] font-medium">
                    Solution has been submitted!
                  </p>
                  <p className="text-[#9e8747] text-sm mt-1">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            {user &&
                              ...
                              !submission.rating && (
                                <Button
                                  className="mt-4 bg-[#fac638] text-[#1c180d] hover:bg-[#fac638]/90"
                                  onClick={() =>
                                    setRatingDialog({
                                      open: true,
          ...
          >
            <DialogContent className="max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>
                  Select a rating for this solution (1-5 stars).
                </DialogDescription>
              </DialogHeader>
