        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center animate-slide-up">
            <div className="inline-flex items-center gap-2 bg-[#fac638]/20 border border-[#fac638]/30 rounded-full px-4 py-2 mb-8 shadow-sm">
              ...
              <span className="text-sm font-medium text-[#1c180d]">100% Anonymous • Secure • Rewarding</span>
            </div>
            ...
            <p className="mt-6 text-lg sm:text-xl leading-8 text-[#9e8747] max-w-3xl mx-auto">
              Upload assignments to get help or solve others' assignments to earn points and recognition. Join a
              thriving community of students helping each other succeed.
            </p>

            {/* Stats */}
            <div className="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-2xl mx-auto">
              <div className="text-center animate-scale-in" style={{ animationDelay: "0.2s" }}>
                <div className="text-2xl sm:text-3xl font-bold text-[#1c180d] drop-shadow">1,200+</div>
                <div className="text-sm text-[#9e8747]">Students</div>
              </div>
              <div className="text-center animate-scale-in" style={{ animationDelay: "0.4s" }}>
                <div className="text-2xl sm:text-3xl font-bold text-[#1c180d] drop-shadow">850+</div>
                <div className="text-sm text-[#9e8747]">Assignments</div>
              </div>
              <div className="text-center animate-scale-in" style={{ animationDelay: "0.6s" }}>
                <div className="text-2xl sm:text-3xl font-bold text-[#1c180d] drop-shadow">95%</div>
                <div className="text-sm text-[#9e8747]">Success Rate</div>
              </div>
              <div className="text-center animate-scale-in" style={{ animationDelay: "0.8s" }}>
                <div className="text-2xl sm:text-3xl font-bold text-[#1c180d] drop-shadow">4.9★</div>
          ...
          {/* Auth Card */}
          <div className="mt-16 flex justify-center animate-scale-in" style={{ animationDelay: "1s" }}>
            <Card className="w-full max-w-md border-2 border-[#fac638] border-opacity-40 bg-white/90 backdrop-blur-lg shadow-2xl card-hover rounded-2xl">
              <CardHeader className="text-center pb-4">
                <div className="mx-auto w-16 h-16 bg-gradient-to-br from-[#fac638] to-[#e6b332] rounded-2xl flex items-center justify-center mb-4 shadow-lg">
                  {otpSent ? <Lock className="w-8 h-8 text-[#1c180d]" /> : <Mail className="w-8 h-8 text-[#1c180d]" />}
                </div>
          ...
          <div className="mt-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: <Shield className="h-8 w-8 text-white" />, title: "100% Anonymous", color: "from-blue-500 to-blue-600" },
              { icon: <Trophy className="h-8 w-8 text-white" />, title: "Earn Points & Recognition", color: "from-green-500 to-green-600" },
              { icon: <Zap className="h-8 w-8 text-white" />, title: "Instant Notifications", color: "from-purple-500 to-purple-600" },
              { icon: <BookOpen className="h-8 w-8 text-white" />, title: "All Subjects", color: "from-orange-500 to-orange-600" },
              { icon: <Award className="h-8 w-8 text-white" />, title: "Quality Solutions", color: "from-pink-500 to-pink-600" },
              { icon: <TrendingUp className="h-8 w-8 text-white" />, title: "Track Progress", color: "from-indigo-500 to-indigo-600" },
            ].map((feature, i) => (
            <Card
                key={feature.title}
            ...
            >
              <CardContent className="p-8 text-center">
                  <div className={`mx-auto w-16 h-16 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-lg`}>
                    {feature.icon}
                </div>
                  <h3 className="text-xl font-semibold text-[#1c180d] mb-3">{feature.title}</h3>
                <p className="text-[#9e8747] leading-relaxed">
                    {feature.title === "100% Anonymous" && "Complete privacy with unique anonymous usernames. Your identity stays protected while you help others."}
                    {feature.title === "Earn Points & Recognition" && "Solve assignments to earn points, climb the leaderboard, and build your reputation in the community."}
                    {feature.title === "Instant Notifications" && "Get notified when your assignments are solved or when you receive ratings for your solutions."}
                    {feature.title === "All Subjects" && "From Mathematics to Computer Science, get help with assignments across all academic disciplines."}
                    {feature.title === "Quality Solutions" && "Rate and review solutions to ensure high-quality help. Build trust through our community-driven system."}
                    {feature.title === "Track Progress" && "Monitor your uploaded assignments and submitted solutions with detailed activity tracking."}
                </p>
              </CardContent>
            </Card>
            ))}
